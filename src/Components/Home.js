...
function Home() {
    ...
    return (
        <div className="home">
            ...
            <img className="home__frontPicSmall" src="https://images-na.ssl-images-amazon.com/images/G/01/AmazonExports/Fuji/2020/October/Fuji_Tallhero_Dash_en_US_1x._CB418727898_.jpg" alt="" />
